...
using AbpProjects.Web.Controllers.Results;
using AbpProjects.Web.Models;
using AbpProjects.Web.Models.Account;
...
{
    public class AccountController : AbpProjectsControllerBase
    {
        ...
        {
            var data = _multiTenancyConfig.IsEnabled;
        ...
        {
            if (model.PasswordRepeat != model.Password)
            {
                return Json("fail");
            }
            else
