(function () {
    angular.module('app').factory('appUserNotificationHelper', [
        '$uibModal', '$location', 'abp.services.app.notifications',
        function ($uibModal, $location, notificationService) {
            ...
            /* Example:
            abp.notifications.messageFormatters['TechnoForms.MyNotificationDataType'] = function(userNotification) {
            ...
            var openSettingsModal = function () {
                $uibModal.open({
                 //   templateUrl: '/App/Main/views/roles/createModal.cshtml',
                    ...
                    controller: 'views.notifications.settingsModal as vm',
                    backdrop: 'static'
                });
            };
