(function () {
    angular.module('app').controller('app.views.project.activeprojects', [
        ...
        function ($scope, $state, $http, $timeout, $uibModal, projectService, uiGridConstants, supportService, userService, appSession) {
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportReportToExcelProjectActive";
            ...
            function getAll() {
                ...
                projectService.getActiveProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
