(function () {
    angular.module('app').controller('app.views.project.ongoingprojects', [
        ...
        function ($scope,$state,$http, $timeout, $uibModal, projectService, uiGridConstants, supportService, userService) {
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportReportToExcelProjectONGOING";
            ...
            function getProjectStatus() {
                projectService.getOnGoingProjectStatus()
                    .then(function (result) {
            ...
            function getAll() {
                ...
                projectService.getOnGoingProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
                        ...
                        if (result.data.totalCount == 0 || vm.userGridOptions.data.length == 0) {
                            ...
                            if (vm.userGridOptions.data[0].username == "Marketing Leader") {
                                vm.ishown = false;
                            }
