(function () {
    angular.module('app').controller('app.views.project.onholdprojects', [
        ...
        function ($scope, $state, $timeout, $http, $uibModal, projectService, uiGridConstants, supportService, userService) {
            ...
            function getProjectStatus() {
                projectService.getOnHoldStatus()
                    .then(function (result) {
            ...
            function getAll() {
                ...
                projectService.getOnHoldProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
                        //debugger;
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportOnHoldProjectToExcel";
