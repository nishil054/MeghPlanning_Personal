(function () {
    angular.module('app').controller('app.views.project.index', [
        '$scope', '$state', '$timeout', '$uibModal', 'abp.services.app.project', 'uiGridConstants', 'abp.services.app.support', 'abp.services.app.user',
        function ($scope, $state, $timeout, $uibModal, projectService, uiGridConstants, supportService, userService) {
            var vm = this;
            vm.ddlProjectStatus = [];
            vm.ddlmarketingList = [];
            vm.project = {};
            ...
            function getAll() {
                ...
                projectService.getProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate: '<div class=\"ui-grid-cell-contents\">' +
                            ...
                            '      <li ng-if= "grid.appScope.chckprojectadminpermission()==true"><a ng-click="grid.appScope.delete(row.entity)">' + App.localize('Delete') + '</a></li>' +
