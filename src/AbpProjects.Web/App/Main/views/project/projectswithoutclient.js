(function () {
    angular.module('app').controller('app.views.project.projectswithoutclient', [
        '$scope', '$state', '$timeout', '$http', '$uibModal', 'abp.services.app.project', 'uiGridConstants', 'abp.services.app.support', 'abp.services.app.user', 'appSession',
        function ($scope, $state, $timeout, $http, $uibModal, projectService, uiGridConstants, supportService, userService, appSession) {
            var vm = this;
            vm.isChecked = true;
            vm.ddlProjectStatus = [];
            vm.ddlmarketingList = [];
            ...
            function getProjectStatus() {
                projectService.getActiveProjectStatus()
                    .then(function (result) {
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportGetProjectsWithoutClientList";
                ...
                $http({
                    ...
                    params: {
                        ...
                        projectStatusId: vm.requestParams.projectStatusId
                    },
            ...
            function getAll() {
                ...
                projectService.getProjectsWithoutClientList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
                        console.log(vm.permissions.adminwrites);
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        cellTemplate: '<div class=\"ui-grid-cell-contents\" >' +
                            ...
                            '</select>' +
                            '<span ng-if="grid.appScope.chckprojectadminpermission()==false || grid.appScope.chckprojectMarketingLeaderpermission()==true">{{row.entity.projectStatus}}</span>' +
                            '</div>',
                        visible: vm.permissions.adminwrites == true || vm.permissions.marketLeads == true,
                    }
                ],
