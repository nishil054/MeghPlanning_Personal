(function () {
    angular.module('app').controller('app.views.project.completedprojects', [
        '$scope', '$state', '$timeout', '$http', '$uibModal', 'abp.services.app.project', 'uiGridConstants', 'abp.services.app.support', 'abp.services.app.user',
        function ($scope, $state, $timeout, $http, $uibModal, projectService, uiGridConstants, supportService, userService) {
            var vm = this;
            vm.ddlProjectStatus = [];
            vm.isChecked = true;
            vm.ddlmarketingList = [];
            //vm.project.projectStatusId = vm.ddlProjectStatus[0];
            vm.project = {};
            vm.projectList = [];
            vm.projectTask = [];
            vm.cname = [];
            ...
            function getProjectStatus() {
                projectService.getCompletedProjectStatus()
                    .then(function (result) {
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportCompleteProjectToExcel";
            ...
            function getAll() {
                ...
                projectService.getCompletedProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
