(function () {
    angular.module('app').controller('app.views.project.amcprojects', [
        ...
        function ($scope, $state,$http, $timeout, $uibModal, projectService, uiGridConstants, supportService, userService) {
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportReportToExcelProjectAMC";
            ...
            function getProjectStatus() {
                projectService.getAmcProjectStatus()
                    .then(function (result) {
            ...
            function getAll() {
                ...
                projectService.getAmcProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
