(function () {
    angular.module('app').controller('app.views.project.allprojects', [
        '$scope', '$state', '$http', '$timeout', '$uibModal', 'abp.services.app.project', 'uiGridConstants', 'abp.services.app.support', 'abp.services.app.user', 'appSession',
        function ($scope, $state, $http, $timeout, $uibModal, projectService, uiGridConstants, supportService, userService, appSession) {
            var vm = this;
            vm.ddlProjectStatus = [];
            vm.ddlmarketingList = [];
            vm.project = {};
            ...
            vm.permissions = {
                ...
                updatePriority: abp.auth.hasPermission('Pages.Update.Project.Priority'),
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/ExportReportToExcelProjectAll";
            ...
            function getProjectStatus() {
                projectService.getStatus()
                    .then(function (result) {
                        vm.ddlProjectStatus = result.data.items;
                        vm.project.projectStatusId = "";
            ...
            function getAll() {
                ...
                projectService.getAllProjectList($.extend({ projectName: vm.searchBox }, vm.requestParams))
                    .then(function (result) {
                        console.log(vm.permissions.adminwrites);
                        vm.projectList = result.data.items;
                        console.log(result.data.items);
                        console.log(result.data.items[0].typeshow)
                        ...
                        if (result.data.totalCount == 0 || vm.userGridOptions.data.length == 0) {
                            ...
                            console.log("Username " + vm.userGridOptions.data[1].username)
