/// <reference path="gstdata.js" />

(function () {
    angular.module('app').controller('app.views.sales.collectionreport', [
        ...
        function ($state, reportsService) {
            ...
            vm.get = function (yearId) {
                abp.ui.setBusy();
                vm.yearId = yearId;
                reportsService.getCollectionReport(vm.yearId).then(function (result) {
