(function () {
    angular.module('app').controller('app.views.reports.opportunityClosingReport', [
        ...
        function ($scope, $state, $uibModal, uiGridConstants, opportunityService, $http, masterListservice) {
            ...
            vm.getAll = function () {
                abp.ui.setBusy();
                vm.loading = true;
                opportunityService.getOpportunityClosingReport($.extend({}, vm.requestParams))
            ...
            function getCallCategory() {
                opportunityService.getCallCategory({}).then(function (result) {
                    ...
                    vm.calllCategoryId = result.data.items[0].id + "";
                });
            }
            ...
            vm.exportExcel = function () {
                ...
                var url = "../exportToExcel/OpportunityClosingReportExport";
