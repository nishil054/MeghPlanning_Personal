    ...
    angular.module('app').controller('app.views.home.editResign', [
        ...
        function ($scope, $uibModalInstance, userService, id) {
                ...
                userService.getRoles()
                    .then(function (result) {
                        ...
                        userService.get({ id: id })
                            .then(function (result) {
                                vm.home = result.data;
                                vm.home.resigndate = moment(vm.home.resigndate);
                                //debugger;
                                console.log(result);
            ...
            vm.save = function () {
                ...
                userService.updateUserResign(vm.home)
                    .then(function (result) {
                        //debugger;
                        console.log(result);
