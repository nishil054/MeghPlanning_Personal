(function () {
    angular.module('app').controller('views.notifications.index', [
        '$scope', '$uibModal', 'uiGridConstants', 'appUserNotificationHelper', 'abp.services.app.notifications',
                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate:
                            ...
                            '  <button ng-click="grid.appScope.setNotificationAsRead(row.entity)" ng-disabled="row.entity.state==\'READ\'" class="btn btnunread btn-xs btn-primary blue" title="' + 'SetAsRead' + '">' +
