(function () {
    angular.module('app').controller('app.views.nthlevelcategories', [
        '$scope', '$state', '$stateParams', '$timeout', '$uibModal', 'abp.services.app.nthCategory', 'uiGridConstants',
        function ($scope, $state, $stateParams, $timeout, $uibModal, nthCategoryService, uiGridConstants) {
            var vm = this;
            vm.categoryList = [];
            vm.AbpSettingslist = [];
            ...
            function getAbpSettingsList() {
                nthCategoryService.getAbpSettingsList()
