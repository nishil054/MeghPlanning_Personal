...
namespace AbpProjects.Migrations.SeedData
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(AbpProjectsDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminRoleForHost == null)
            {
                ...
                //adminRoleForHost = new Role
                //{
                //    Name = StaticRoleNames.Host.Support,
                //    DisplayName = StaticRoleNames.Host.Support,
                //    IsStatic = true
                //};
